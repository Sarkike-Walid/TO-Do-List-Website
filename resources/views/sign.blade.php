...
<div class="auth-container">
  ...
  <div class="auth-card">
    ...
    <p class="auth-sub">A calmer way to manage your day is just steps away.</p>
    
    <form action="{{ route('register') }}" method="POST">
      @csrf
      <div class="form-group">
        <label class="form-label">Full name</label>
        <input type="text" name="name" class="form-control" placeholder="Jane Doe" value="{{ old('name') }}" required autofocus>
      ...
      <div class="form-group">
        ...
        @error('password') <div style="color: #e74c3c; font-size: 12px; margin-top: 4px;">{{ $message }}</div> @enderror
      </div>
