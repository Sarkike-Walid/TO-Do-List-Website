...
<head>
  ...
  <title>Forgot Password — Lumido</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    [data-theme="dark"] .status-msg {
      background: rgba(59,154,237,0.15);
      border-color: rgba(59,154,237,0.4);
      color: #3b9aed;
    }
  </style>
</head>
  ...
  <div class="container-xl px-5">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navMenu">
      <ul class="navbar-nav align-items-center gap-1">
        ...
        <li class="nav-item"><a class="nav-link nav-login" href="{{ url('/login') }}">Login</a></li>
        <li class="nav-item"><a class="nav-link nav-cta" href="{{ url('/sign') }}">Get started</a></li>
        <li class="nav-item">
...
<div class="auth-container">
  ...
  <div class="auth-card">
    ...
    <p class="auth-sub">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link.</p>
    ...
    <form method="POST" action="{{ route('password.email') }}">
      ...
      <div class="form-group">
        ...
        @error('email') <div style="color: #e74c3c; font-size: 12px; margin-top: 4px;">{{ $message }}</div> @enderror
      </div>
      
      <button type="submit" class="btn-auth">Email Reset Link</button>
    </form>
